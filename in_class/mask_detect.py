...
while True:
    ...
    for (x,y,w, h) in eyes:
        ...
        cv2.putText(gray,'eyes',(x,y),cv2.FONT_HERSHEY_SIMPLEX,1,(0,0, 255), 1)


    for (x, y, w, h) in faces:
        cv2.rectangle(gray, (x, y), (x+w, y+h), (255, 0, 255), 2)
        cv2.putText(gray,'Face',(x,y),cv2.FONT_HERSHEY_SIMPLEX,1,(0,0, 255), 1)
        
    for (x,y,w, h) in mouth:
        cv2.rectangle(gray, (x, y), (x+w, y+h), (255, 0, 0), 2)
        cv2.putText(gray,'mouth',(x,y),cv2.FONT_HERSHEY_SIMPLEX,1,(0,0, 255), 1)
